...
class Res2Net(nn.Module):
    ...
    def __init__(self, block, layers, baseWidth=26, scale=4, os=8, num_classes=1000):
        self.inplanes = 64
        ...
        self.layer4 = self._make_MG_layer(block, 512, layers[3], stride=strides[3], dilation=dilations[3])
